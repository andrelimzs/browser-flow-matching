...
window.localStorage.setItem("pusht-demos-v1", JSON.stringify({ version: 2, episodes: [{ source: "mouse" }, null, 7] }));
...
const bytes = JSON.stringify({ version: 2, episodes: store.episodes }).length;
