...
if (process.env.OUT) {
  writeFileSync(process.env.OUT, JSON.stringify({
    ...
    reward: "signed block-goal, pusher-goal, and orientation progress + final overlap closeness + completion; -1 and termination after 5 stationary pusher steps; wall penalty components default off",
    seed,
    totalSteps,
    horizon,
    curriculum,
